...
export default function Rexettes() {
    ...
    return (
        ...
        <Grid container style={{ paddingLeft: '5%',paddingRight:'5%' }} justifyContent='space-between' alignItems='center'>
            <Grid Item md={6}>
                <Typography variant='h3' style={{ fontSize: '32px',paddingBlockEnd:'24px' }}>Decouvrez toutes nos categories de recettes</Typography>
    ...
    >
       <InputBase
        sx={{ ml: 1, flex: 1 }}
        placeholder="Trouvez une categorie..."
    ...
    }
    {
        isXs&&(
            ...
            <Grid container  p='0 5%' >
                ...
                <Grid Item xs={12}>
                <Typography variant='h3' style={{ fontSize: '19px',paddingBlockEnd:'24px',paddingBlockStart:'16px'}}>Decouvrez toutes nos categories de recettes</Typography>
